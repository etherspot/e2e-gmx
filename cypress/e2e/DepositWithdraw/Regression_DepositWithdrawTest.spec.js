...
describe('Regression Test Cases of the Deposit and Withdraw Flow', () => {
  ...
  it('REGRESSION: Perform the Withdraw Transaction with ERC20 Token and Enabled one click trading option on Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        ...
        managewallet.search.type(data.usdc);

        // click on the respective usdc option
        managewallet.usdc.click();
  ...
  it('REGRESSION: Perform the Withdraw Transaction with ERC20 Token and Disabled one click trading option on Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
  ...
  it('REGRESSION: Perform the Withdraw Transaction with Exceeded Amount on Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
        ...
        console.error(e);
        assert.fail(
          'The withdraw transaction with exceeded amount is not performed.'
        );
      }
    });
  });

  it('REGRESSION: Perform the Withdraw Transaction with Small Amount on Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
        ...
        managewallet.enteranAmount.should('be.visible');
        ...
        console.error(e);
        assert.fail(
          'The withdraw transaction with Small amount is not performed.'
        );
      }
    });
  });

  it('REGRESSION: Perform the Withdraw Transaction with Zero Amount and without Amount on Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
        ...
        // clear the amount from the input field
        managewallet.withdrawAmount.clear();
        ...
        console.error(e);
        assert.fail(
          'The withdraw transaction with Zero Amount and without Amount is not performed.'
        );
      }
    });
  });

  it('REGRESSION: Perform the Withdraw Transaction with valid details and reject the transaction requiest from metamask for Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
        ...
        // close the withdraw failed message
        managewallet.closeFailedModel.click();
        ...
        console.error(e);
        assert.fail(
          'The withdraw transaction with valid details and reject the transaction requiest from metamask is not performed.'
        );
      }
    });
  });

  it('REGRESSION: Perform the Deposit Transaction with ERC20 Token and Enabled one click trading option and valid details on Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
  ...
  it('REGRESSION: Perform the Deposit Transaction with ERC20 Token and Disabled one click trading option and valid details on Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
  ...
  it('REGRESSION: Perform the Deposit Transaction with Exceeded Amount on Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
        ...
        console.error(e);
        assert.fail(
          'The deposit transaction with exceeded amount is not performed.'
        );
      }
    });
  });

  it('REGRESSION: Perform the Deposit Transaction with Small Amount on Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
        ...
        console.error(e);
        assert.fail(
          'The Deposit transaction with Small amount is not performed.'
        );
      }
    });
  });

  it('REGRESSION: Perform the Deposit Transaction with Zero Amount and without Amount on Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
        ...
        // clear the amount from the input field
        managewallet.depositAmount.clear();
        ...
        console.error(e);
        assert.fail(
          'The Deposit transaction with Zero Amount and without Amount is not performed.'
        );
      }
    });
  });

  it('REGRESSION: Perform the Deposit Transaction with valid details and reject the transaction requiest from metamask for Arbitrum Network', () => {
    cy.fixture('DepositWithdraw').then((data) => {
      try {
        // click on the user avatar
        home.userAvatar.click();
        ...
        // close the deposit failed message
        managewallet.closeFailedModel.click();
        ...
        console.error(e);
        assert.fail(
          'The deposit transaction with valid details and reject the transaction requiest from metamask is not performed.'
        );
      }
    });
  });
